 ...
 * {@link IdentificationDatabase.service.impl.SettingsLocalServiceImpl} and is the
 ...
 * @see IdentificationDatabase.service.base.SettingsLocalServiceBaseImpl
...
public class SettingsLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link IdentificationDatabase.service.impl.SettingsLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static IdentificationDatabase.model.Settings addSettings(
	...
	*/
	public static IdentificationDatabase.model.Settings createSettings(long id) {
		return getService().createSettings(id);
	}
	...
	*/
	public static IdentificationDatabase.model.Settings deleteSettings(
		IdentificationDatabase.model.Settings settings) {
	...
	*/
	public static IdentificationDatabase.model.Settings deleteSettings(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteSettings(id);
	}

	public static IdentificationDatabase.model.Settings fetchSettings(long id) {
		return getService().fetchSettings(id);
	}
	...
	* @throws PortalException if a settings with the primary key could not be found
	*/
	public static IdentificationDatabase.model.Settings getSettings(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getSettings(id);
	}
	...
	*/
	public static IdentificationDatabase.model.Settings updateSettings(
		IdentificationDatabase.model.Settings settings) {
	...
	*/
	public static java.util.List<IdentificationDatabase.model.Settings> getSettingses(
		int start, int end) {
	...
	*/
	...
	private static ServiceTracker<SettingsLocalService, SettingsLocalService> _serviceTracker =
		ServiceTrackerFactory.open(SettingsLocalService.class);
}