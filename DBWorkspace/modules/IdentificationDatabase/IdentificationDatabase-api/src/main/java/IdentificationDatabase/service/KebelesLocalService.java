...
/**
 * Provides the local service interface for Kebeles. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see KebelesLocalServiceUtil
...
public interface KebelesLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link KebelesLocalServiceUtil} to access the kebeles local service. Add custom service methods to {@link IdentificationDatabase.service.impl.KebelesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Kebeles addKebeles(Kebeles kebeles);
	...
	*/
	public Kebeles createKebeles(long id);
	...
	*/
	...
	public Kebeles deleteKebeles(Kebeles kebeles);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Kebeles deleteKebeles(long id) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Kebeles fetchKebeles(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Kebeles getKebeles(long id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public Kebeles updateKebeles(Kebeles kebeles);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Kebeles> getKebeleByAm(java.lang.String kebele_AM)
		throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Kebeles> getKebeleByOr(java.lang.String kebele_OR)
		throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Kebeles> getKebeleByPrinterName(java.lang.String printerName)
		throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Kebeles> getKebeleBySubcityAm(java.lang.String Subcity_AM)
		throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Kebeles> getKebeleBySubcityOr(java.lang.String Subcity_OR)
		throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Kebeles> getKebeleForId(long id) throws SystemException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Kebeles> getKebeleses(int start, int end);
