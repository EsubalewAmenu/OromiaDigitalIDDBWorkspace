...
/**
 * Provides the local service interface for CitizenRemark. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CitizenRemarkLocalServiceUtil
...
public interface CitizenRemarkLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CitizenRemarkLocalServiceUtil} to access the citizen remark local service. Add custom service methods to {@link IdentificationDatabase.service.impl.CitizenRemarkLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public CitizenRemark addCitizenRemark(CitizenRemark citizenRemark);
	...
	*/
	public CitizenRemark createCitizenRemark(long id);
	...
	*/
	...
	public CitizenRemark deleteCitizenRemark(CitizenRemark citizenRemark);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public CitizenRemark deleteCitizenRemark(long id) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CitizenRemark fetchCitizenRemark(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CitizenRemark getCitizenRemark(long id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public CitizenRemark updateCitizenRemark(CitizenRemark citizenRemark);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CitizenRemark> getCitizenRemarks(int start, int end);
