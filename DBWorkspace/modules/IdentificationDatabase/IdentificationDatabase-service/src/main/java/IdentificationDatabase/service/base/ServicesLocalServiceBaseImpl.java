...
import IdentificationDatabase.service.ServicesLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link IdentificationDatabase.service.impl.ServicesLocalServiceImpl}.
 * </p>
 *
...
public abstract class ServicesLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ServicesLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link IdentificationDatabase.service.ServicesLocalServiceUtil} to access the services local service.
	 */
	...
	public Services createServices(long id) {
		return servicesPersistence.create(id);
	}
	...
	public Services deleteServices(long id) throws PortalException {
		return servicesPersistence.remove(id);
	}
	...
	public Services fetchServices(long id) {
		return servicesPersistence.fetchByPrimaryKey(id);
	}
	...
	public Services getServices(long id) throws PortalException {
		return servicesPersistence.findByPrimaryKey(id);
	}
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(servicesLocalService);
	 ...
	 */
	public ServicesLocalService getServicesLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("IdentificationDatabase.model.Services",
			servicesLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"IdentificationDatabase.model.Services");
	}
	...
	@BeanReference(type = ServicesLocalService.class)
